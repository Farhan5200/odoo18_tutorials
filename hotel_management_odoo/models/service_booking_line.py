...
class ServiceBookingLine(models.Model):
    ...
    def _get_default_uom_id(self):
        ...
        return self.env.ref('product_uom.product_uom_unit')
    ...
    description = fields.Char(string='Description', related='service_id.descriptions',
    ...
    def _convert_to_tax_base_line_dict():
        ...
        self.ensure_one()
        return self.env['account.tax']._convert_tax_base_line_dict(
            self,
